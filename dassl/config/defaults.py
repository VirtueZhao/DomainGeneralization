...
# Use all data in the unlabeled dataset (e.g. FixMatch)
...
# Setting for the train_u data_loader
...
# MCD                                   # Single-Source Domain Adaptation
_C.TRAINER.MCD = CN()                   # Maximum Classifier Discrepancy for Unsupervised Domain Adaptation (CVPR'18)
_C.TRAINER.MCD.N_STEP_F = 4             # number of steps to train F
# MME                                   # Single-Source Domain Adaptation
_C.TRAINER.MME = CN()                   # Semi-Supervised Domain Adaptation via Minimax Entropy (ICCV'19)
_C.TRAINER.MME.LMDA = 0.1               # weight for the entropy loss
# SelfEnsembling                        # Single-Source Domain Adaptation
_C.TRAINER.SE = CN()                    # Self-Ensembling for Visual Domain Adaptation (ICLR'18)
_C.TRAINER.SE.EMA_ALPHA = 0.999
_C.TRAINER.SE.CONF_THRE = 0.95
_C.TRAINER.SE.RAMPUP = 300

# M3SDA                                 # Multi-Source Domain Adaptation
...
# EntMin                                # Semi-Supervised Learning
_C.TRAINER.ENTMIN = CN()                # Semi-Supervised Learning by Entropy Minimization (NeurIPS'04)
_C.TRAINER.ENTMIN.LMDA = 1e-3           # weight on the entropy loss
# Mean Teacher                          # Semi-Supervised Learning
_C.TRAINER.MEANTEA = CN()               # Mean Teachers are Better Role Models (NeurIPS'17)
...
_C.TRAINER.MIXMATCH = CN()              # MixMatch: A Holistic Approach to Semi-Supervised Learning (NeurIPS'19)
...
_C.TRAINER.FIXMATCH = CN()              # FixMatch: Simplifying Semi-Supervised Learning with Consistency and Confidence
